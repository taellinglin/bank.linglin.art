...
class Settings(db.Model):
    ...
    icon_dir = db.Column(db.String(255), default="./icons")
    eisenscript_dir = db.Column(db.String(255), default="./eisen")
    ...
    eisenscript_prefix_coin_front = db.Column(db.Text, default="")
    eisenscript_suffix_coin_front = db.Column(db.Text, default="")
    eisenscript_prefix_coin_back = db.Column(db.Text, default="")
    eisenscript_suffix_coin_back = db.Column(db.Text, default="")
    eisenscript_prefix_card_front = db.Column(db.Text, default="")
    eisenscript_suffix_card_front = db.Column(db.Text, default="")
